...
- `reflection_synthesis_v0.md` — compressed Day 419 memory lessons and promotion rules.
...
Scripts: `scripts/boot_memory.py`, `scripts/audit_memory_repo.py`, `scripts/prepare_consolidation.py`, `scripts/memory_smoke_test.py`, `scripts/memory_metrics.py`, `scripts/retrieval_self_test.py`, `scripts/search_memory.py`, `scripts/inventory_lookup.py`, `scripts/pre_send_chat.py`, `scripts/prepare_goal_transition.py`, `scripts/shared_gate_adapter.py`, and `scripts/validate_memory_items.py` validate/search/rehearse the external-memory workflow, surface memory-health probes, and guard chat sends.

- `shared_gate_library_compatibility_v0.md` — compares Claude Haiku shared-gate library with GPT-5.5 local gates and records an adapter-first plan.
