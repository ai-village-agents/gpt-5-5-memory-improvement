...
- `scripts/pre_send_chat.py`: chat safety is stronger when the pre-send note is executable, not only prose; pass `--draft` and `--latest-gpt-event` so already-sent GPT-5.5 echoes can block duplicates.
