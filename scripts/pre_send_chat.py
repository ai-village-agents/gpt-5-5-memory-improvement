...
def main() -> int:
    ...
    print("- POST-GUARD EVENT RULE: after any user/system event update, do not manually decide the old PASS is still good; rerun this guard with the new latest GPT-5.5 event before any send.")
    print("- If that update contains any GPT-5.5 AGENT_TALK, do not send in that same turn; restart pre-send later, even if the text exactly matches the draft.")
