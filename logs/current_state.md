...
Updated: Day 419, after adding compact draft checker, malformed-inventory regression, and structural-drift reflection lesson.
...
- `scripts/memory_smoke_test.py`: verifies boot files, audit, search, malformed inventory rejection, and consolidation worksheet.
